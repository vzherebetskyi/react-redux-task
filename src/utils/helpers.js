...
export const getFilteredArticles = (articles, appliedDates, appliedCategories, appliedSources) => {
  ...
  const filteredArticles = articles.filter(article => datesFilterOptions.includes(article.unifiedDate) && categoriesFilterOptions.includes(article.category) && sourcesFilterOptions.includes(article.source));
