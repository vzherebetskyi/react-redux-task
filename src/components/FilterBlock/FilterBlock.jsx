      ...
      <div className={`filter-wrapper ${filtOpened ? 'filter-wrapper__opened' : ''}`}>
        ...
        <div className='filters-container'>
            ...
            <p className='section-name'>Preferences:</p>
              ...
              {(preferredSources.length > 0 || preferredCategories.length > 0 || preferredAuthors.length > 0) && <button className='common-button' onClick={handleResetAllPreferences}>Reset Preferences</button>}
            </div>
        </div>
        }
